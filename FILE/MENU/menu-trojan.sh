...
function addtrojan(){
source /var/lib/dendikusnandi-pro/ipvps.conf
...
trojanlink="trojan://${uuid}@${domain}:${tr}?path=%2Fdendikusnandi&security=tls&host=bug.com&type=ws&sni=bug.com#${user}"
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}           ${WH}• CREATE TROJAN USER •              ${NC} $COLOR1 $NC"
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
...
echo -e "$COLOR1 ${NC} ${WH}Path        ${COLOR1}: ${WH}/dendikusnandi (/Custom path)"
echo -e "$COLOR1 ${NC} ${WH}Path WSS    ${COLOR1}: ${WH}wss://bug.com/dendikusnandi (/Custom path)" 
