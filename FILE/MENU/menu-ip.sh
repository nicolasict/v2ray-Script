...
APIGIT=$(cat /etc/dendikusnandi/github/api)
EMAILGIT=$(cat /etc/dendikusnandi/github/email)
USERGIT=$(cat /etc/dendikusnandi/github/username)
...
if [[ -f /etc/dendikusnandi/github/api && -f /etc/dendikusnandi/github/email && /etc/dendikusnandi/github/username ]]; then
   rec="OK"
else
    mkdir /etc/dendikusnandi/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/dendikusnandi/github/email
echo "$USERNAME1" > /etc/dendikusnandi/github/username
echo "$API1" > /etc/dendikusnandi/github/api
echo "ON" > /etc/dendikusnandi/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
function resetipvps(){
clear
rm -f /etc/dendikusnandi/github/email
rm -f /etc/dendikusnandi/github/username
rm -f /etc/dendikusnandi/github/api
rm -f /etc/dendikusnandi/github/gitstat
echo "OFF" > /etc/dendikusnandi/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/dendikusnandi/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/dendikusnandi/github
    touch /etc/dendikusnandi/github/gitstat
    echo "OFF" > /etc/dendikusnandi/github/gitstat
fi

stst1=$(cat /etc/dendikusnandi/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• REGISTER IPVPS •              ${NC} $COLOR1 $NC"
...
stst=$(cat /etc/dendikusnandi/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
