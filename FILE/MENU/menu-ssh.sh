...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/dendikusnandi/iLoveU/main/FILE/WEBSOCKET/proxy3.js"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}" 
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/dendikusnandi/iLoveU/main/FILE/SSH/sshws-true.sh" && chmod +x /usr/bin/ssh-wsenabler
